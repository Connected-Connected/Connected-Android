package com.connected.beta.activity.main.fragment;
...
import com.connected.beta.activity.message.MessageDetailActivity;
import com.connected.beta.connected.R;
import com.connected.beta.object.recycler.MessageRecyclerAdapter;
import com.connected.beta.object.recycler.MessageRow;
import com.connected.beta.object.recycler.RecyclerItemClickListener;
import com.connected.beta.object.recycler.SimpleDividerItemDecoration;
import com.connected.beta.activity.message.MessageWriteActivity;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        btWriteMessage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(getActivity(), MessageWriteActivity.class));
            }
        });
