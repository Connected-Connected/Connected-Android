package com.beta.connected.connected.Module.File;
...
/**
 * Created by x-note on 2017-02-24.
 */
...
public class FileTransfer {
    ...
    private class FileTransferWithPath extends AsyncTask<Queue<HashMap<String, String>>, Void, Queue<HashMap<String, String>>> {
        ...
        @Override
        protected Queue<HashMap<String, String>> doInBackground(Queue<HashMap<String, String>>... params) {
            try
            {
        ...
        @Override
        protected void onPostExecute(Queue<HashMap<String, String>> result) {
            if (result != null) {
                Message msg = handler.obtainMessage();
                Bundle resultData = new Bundle();
                //resultData.putSerializable("result");
